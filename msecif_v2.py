...
ECIF_ProteinAtoms = ['C;4;1;3;0', 'C;4;2;1;1', 'C;4;2;2;0', 'C;4;2;2;1', 
                     'C;4;3;0;0', 'C;4;3;0;1', 'C;4;3;1;0', 'C;4;3;1;1', 
                     'C;5;3;0;0', 'C;6;3;0;0', 'N;3;1;2;0', 'N;3;2;0;1', 
                     'N;3;2;1;0', 'N;3;2;1;1', 'N;3;3;0;1', 'N;4;1;2;0', 
                     'N;4;1;3;0', 'N;4;2;1;0', 'O;2;1;0;0', 'O;2;1;1;0', 
                     'S;2;1;1;0', 'S;2;2;0;0']
...
ECIF_LigandAtoms = ['Br;1;1;0;0', 'C;3;3;0;1', 'C;4;1;1;0', 'C;4;1;2;0', 
                    'C;4;1;3;0', 'C;4;2;0;0', 'C;4;2;1;0', 'C;4;2;1;1', 
                    'C;4;2;2;0', 'C;4;2;2;1', 'C;4;3;0;0', 'C;4;3;0;1', 
                    'C;4;3;1;0', 'C;4;3;1;1', 'C;4;4;0;0', 'C;4;4;0;1', 
                    'C;5;3;0;0', 'C;5;3;0;1', 'C;6;3;0;0', 'Cl;1;1;0;0', 
                    'F;1;1;0;0', 'I;1;1;0;0', 'N;3;1;0;0', 'N;3;1;1;0', 
                    'N;3;1;2;0', 'N;3;2;0;0', 'N;3;2;0;1', 'N;3;2;1;0', 
                    'N;3;2;1;1', 'N;3;3;0;0', 'N;3;3;0;1', 'N;4;1;2;0', 
                    'N;4;1;3;0', 'N;4;2;1;0', 'N;4;2;2;0', 'N;4;2;2;1', 
                    'N;4;3;0;0', 'N;4;3;0;1', 'N;4;3;1;0', 'N;4;3;1;1', 
                    'N;4;4;0;0', 'N;4;4;0;1', 'N;5;2;0;0', 'N;5;3;0;0', 
                    'N;5;3;0;1', 'O;2;1;0;0', 'O;2;1;1;0', 'O;2;2;0;0', 
                    'O;2;2;0;1', 'P;5;4;0;0', 'P;6;4;0;0', 'P;6;4;0;1', 
                    'P;7;4;0;0', 'S;2;1;0;0', 'S;2;1;1;0', 'S;2;2;0;0', 
                    'S;2;2;0;1', 'S;3;3;0;0', 'S;3;3;0;1', 'S;4;3;0;0', 
                    'S;6;4;0;0', 'S;6;4;0;1', 'S;7;4;0;0']
...
# This function takes an SDF for a ligand as input and returns it as a pandas DataFrame with its atom types labeled according to ECIF
    ...
    if m is None:
        print(f"######### ERROR!!!!: m is None. sdf file {SDF} #############")
...
Atom_Keys=pd.read_csv(os.path.join(os.path.dirname(__file__), "PDB_Atom_Keys_v2.csv"), sep=",")
def LoadPDBasDF(PDB):
...
def get_multi_shelled_ecif(protein_pdb, ligand_sdf, shells):
    distance_cutoff = max(shells)
    pairs = GetPLPairs(protein_pdb, ligand_sdf, distance_cutoff=distance_cutoff)

    total_counts = list()
    for shell in shells:
        filtered = pairs[pairs['DISTANCE'] < shell]
        total_counts.append([list(filtered["ECIF_PAIR"]).count(x) for x in PossibleECIF])
    feature = np.diff(np.array(total_counts), axis=0, prepend=0).flatten()
    return feature

def make_feature_names_multi_shelled_ecif(shells):
    feature_name =  [
        pecif + '-' + str(shell) 
            for shell in shells 
                for pecif in PossibleECIF]
    return feature_name

    
def get_weighted_ecif(protein_pdb, ligand_sdf, distance_cutoff=6.0, squared=True):
    pl_pairs = GetPLPairs(protein_pdb, ligand_sdf, distance_cutoff=distance_cutoff)
    pl_pairs = pl_pairs[pl_pairs['ECIF_PAIR'].isin(PossibleECIF)]

    pl_pairs['ECIF_PAIR_ID'] = pl_pairs['ECIF_PAIR'].map(dict(zip(PossibleECIF, range(len(PossibleECIF)))))
    if squared:
        pl_pairs['REC_DISTANCE'] = np.square(np.reciprocal(pl_pairs['DISTANCE']))
    else:
        pl_pairs['REC_DISTANCE'] = np.reciprocal(pl_pairs['DISTANCE'])
    feature = np.bincount(pl_pairs['ECIF_PAIR_ID'],
        weights=pl_pairs['REC_DISTANCE'],
        minlength=len(PossibleECIF)
    )
    return feature
